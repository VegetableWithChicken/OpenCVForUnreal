...
#include "OpenCVForUnrealActor.generated.h"
...
class OPENCVFORUNREAL_API AOpenCVForUnrealActor : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AOpenCVForUnrealActor();
...
public:
	...
	/**cut image of size*/
	FVector2D CutImageSize = FVector2D(250,250);
...
class OPENCVFORUNREAL_API FReadImageRunnable :public FRunnable
{
public:
	static FReadImageRunnable* InitReadRunnable(AOpenCVForUnrealActor* inActor)
	{
...
public:
	...
	virtual uint32 Run() override
	{
		if (!ReadActor)
		{
			UE_LOG(LogTemp, Warning, TEXT("AOpenCVForUnrealActor Actor is not spawn"));
			return 1;
		}
...
protected:
	FReadImageRunnable(AOpenCVForUnrealActor* inReadActor) 
	{
...
private:
	...
	AOpenCVForUnrealActor* ReadActor;
