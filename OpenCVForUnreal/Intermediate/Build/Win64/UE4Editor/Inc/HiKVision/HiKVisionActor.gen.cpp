...
// End Cross Module References
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::NewProp_outRGB = { "outRGB", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HikVisionActor_eventShowNativeImage_Parms, outRGB), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::NewProp_outRGB,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/HiKVisionActor.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AHikVisionActor, nullptr, "ShowNativeImage", nullptr, nullptr, sizeof(HikVisionActor_eventShowNativeImage_Parms), Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AHikVisionActor_ShowNativeImage()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AHikVisionActor_ShowNativeImage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OpenFace_MetaData[];
#endif
		static void NewProp_OpenFace_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_OpenFace;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OpenBody_MetaData[];
#endif
		static void NewProp_OpenBody_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_OpenBody;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AHikVisionActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AHikVisionActor_ShowCutImage, "ShowCutImage" }, // 2533481207
		{ &Z_Construct_UFunction_AHikVisionActor_ShowDNNFaceImageArr, "ShowDNNFaceImageArr" }, // 952380720
		...
		{ &Z_Construct_UFunction_AHikVisionActor_ShowNativeImage, "ShowNativeImage" }, // 958641923
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenFace_MetaData[] = {
		{ "Category", "HikVisionActor" },
		{ "ModuleRelativePath", "Public/HiKVisionActor.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenFace = { "OpenFace", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AHikVisionActor), &Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenFace_SetBit, METADATA_PARAMS(Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenFace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenFace_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenBody_MetaData[] = {
		{ "Category", "HikVisionActor" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenBody = { "OpenBody", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AHikVisionActor), &Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenBody_SetBit, METADATA_PARAMS(Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenBody_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenBody_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AHikVisionActor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenFace,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AHikVisionActor_Statics::NewProp_OpenBody,
	};
	...
	IMPLEMENT_CLASS(AHikVisionActor, 1961541148);
