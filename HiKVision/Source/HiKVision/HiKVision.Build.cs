...
public class HiKVision : ModuleRules
{
    public HiKVision(ReadOnlyTargetRules Target) : base(Target)
    {
       ...
       // string HCNetSDKComPath = Path.Combine(HiKVisionPath, "Library", "HCNetSDKCom");
        ...
        PublicAdditionalLibraries.AddRange(
            new string[]
            {
               ...
               // Path.Combine(OpenCVPath,"lib","x64","opencv_world453d.lib"),
                //Path.Combine(OpenCVPath,"lib","x64","opencv_world453.lib"),
       ...
       // RuntimeDependencies.Add("$(PluginDir)/ThirdParty/OpenCVLibrary/dll/opencv_world453d.dll");
       // RuntimeDependencies.Add("$(PluginDir)/ThirdParty/OpenCVLibrary/dll/opencv_world453.dll");
       // RuntimeDependencies.Add("$(PluginDir)/ThirdParty/OpenCVLibrary/dll/opencv_videoio_msmf453_64d.dll");
        //RuntimeDependencies.Add("$(PluginDir)/ThirdParty/OpenCVLibrary/dll/opencv_videoio_ffmpeg453_64.dll");
        //First Main dll
    }
}
